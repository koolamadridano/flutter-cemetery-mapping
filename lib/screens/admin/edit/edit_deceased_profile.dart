...
class EditDeceasedProfile extends StatefulWidget {
  const EditDeceasedProfile({Key? key}) : super(key: key);

  @override
  State<EditDeceasedProfile> createState() => _EditDeceasedProfileState();
}

class _EditDeceasedProfileState extends State<EditDeceasedProfile> {
  var locations = [
    "zone-1-a",
    "zone-1-b",
    "zone-1-c",
